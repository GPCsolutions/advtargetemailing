...
/**
 * 	\defgroup	TargetingEmailing	Advance Targeting Emailling module
 * 	\brief		TargetingEmailing module descriptor.
 * 	\file		core/modules/modTargetingEmailing.class.php
 * 	\ingroup	TargetingEmailing
 * 	\brief		Description and activation file for module TargetingEmailing
 */
 ...
 */
class modAdvTargetEmailing extends DolibarrModules
{
	 ...
	 */
	function modAdvTargetEmailing($db)
	{
		global $langs, $conf;
		...
		// (where XXX is value of numeric property 'numero' of module)
		$this->description = "Advance Targeting Emailling for mass emailing module";
		...
		$this->picto = 'advtargetemailing@advtargetemailing'; // mypicto@mymodule
		...
		$this->config_page_url = array("admin_advtargetemailing.php@advtargetemailing");
	...
	{
		return $this->_load_tables('/advtargetemailing/sql/');
	}
